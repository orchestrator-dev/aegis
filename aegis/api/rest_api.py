...
from aegis.core.models import AgentManifest, Finding, Severity
from aegis.core.orchestrator import ScanOrchestrator
from aegis.api.schemas import ScanRequest, ScanResponse, ScanResultDTO, DashboardMetrics
from aegis.security.auth import AuthorizationSystem

app = FastAPI(title="Aegis AI Security Scanner API", version="1.0.0")
...
async def verify_api_key(credentials: HTTPAuthorizationCredentials = Depends(security)):
    """Dependency: verify Bearer token against the configured AEGIS_API_KEY."""
...
async def create_scan(
    ...
    async def run_scan_bg():
        try:
            ...
            # Aegis' orchestrator needs plugins loaded. Let's do a basic instantiation
